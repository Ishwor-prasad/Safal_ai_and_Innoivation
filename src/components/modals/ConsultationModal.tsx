  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-lg bg-[#0E1A12] rounded-3xl overflow-hidden shadow-2xl border border-brand-light/25 flex flex-col max-h-[90vh]"
      >
        <div className="bg-[#0E1A12] p-6 text-white relative border-b border-white/10">
          <button
          ...
          <div className="flex items-center gap-2 bg-brand-light/10 border border-brand-light/30 px-2.5 py-0.5 rounded-full text-[10px] font-mono tracking-wider w-fit uppercase text-brand-light mb-2">
        ...
        <div className="flex-1 overflow-y-auto p-6 sm:p-8 space-y-4">
          {consultSuccessMsg ? (
            <div className="p-6 bg-brand-light/10 border border-brand-light/30 rounded-2xl text-brand-light space-y-3" id="modal-success-box">
            ...
            <form onSubmit={handleBookConsultation} className="space-y-4" id="consultation-form">
              ...
              <div>
                ...
                <select
                  ...
                  className="glass-input w-full px-4 py-2.5 text-xs text-white cursor-pointer [&>option]:bg-[#0E1A12] [&>option]:text-white"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-slate-900/90 border border-slate-700 rounded-xl p-4 text-xs text-white focus:outline-none focus:border-brand-light resize-none placeholder:text-slate-400"
                />
              </div>
